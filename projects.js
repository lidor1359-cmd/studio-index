...
window.STUDIO_PROJECTS = {
  hub: { local: './index.html', production: '/' },
  'gitsis-real-estate': { local: '../gitsis-real-estate/index.html', production: 'https://gitsis-real-estate-nt2h0dhjg-lidor-levins-projects.vercel.app' },
